<?php session_start();
	...
	if (isset($_SESSION['admin_logged_in'])) {
		...
		if(isset($_POST["repository_item_name"])){
			...
			$new_repository_id = addRepositoryItem($repository_item_name,$repository_art,$repository_typ,$repository_date,$repository_material_number,$repository_file_url,$repository_old_file_url,$_SESSION['lang']);
