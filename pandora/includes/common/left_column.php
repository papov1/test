	...
	echo '
		<div class="left_column">
			<div class="column_content">
				...
				<a href="footer.php" '.($current_page == 'footer.php' ? 'class="active_page"' : '').' ><i class="pe-7s-home"></i> Footer</a>
				<a href="cookie_banner.php" '.($current_page == 'cookie_banner.php' ? 'class="active_page"' : '').' ><i class="pe-7s-culture"></i> Cookie Banner</a>
