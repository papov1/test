...
<html>
	<head>
        <?php if($_SERVER['SERVER_NAME'] !== 'testal.devv'): ?>
	...
	<body>
		...
		<div id="main_container">
			...
			<div id="fullpage">
                ...
                <!-- **************** CALCULATOR **************** -->
                <div class="section calculator_section">
                    <div class="calculator_content">
                        <p class="calculator_title"><?=$translation[81]?><br></p>
                        <div class="gaseumrechner">
                            ...
                            <div>
                                <p class="calculator_subtitle"><?=$translation[82]?></p>
                                <p class="gaspicker">
